...
class Canvas(QtWidgets.QWidget):
    ...
    def _shapes_from_ai_points(
        ...
        image: np.ndarray = labelme._utils.img_qt_to_arr(img_qt=self.pixmap.toImage())
    ...
    def _drag_hovered_rotation_point(self, pos: QPointF) -> None:
        ...
        current_angle = labelme._utils.direction_angle(
    ...
    def _capture_rotation_anchors(self) -> None:
        ...
        self._rotation_initial_angle = labelme._utils.direction_angle(
    ...
    def load_pixmap(self, pixmap: QtGui.QPixmap, clear_shapes: bool = True) -> None:
        pixmap_arr = labelme._utils.img_qt_to_arr(img_qt=pixmap.toImage())
        self.pixmap = pixmap
...
def _project_oriented_rectangle_corners(
    *, anchor: QPointF, edge_axis: QPointF, moving: QPointF
    ...
    perp = labelme._utils.project_point_on_perpendicular_line(
    ...
    *,
    ...
    if not allow_out_of_bounds:
        if _is_out_of_image(moving, image_size):
            ...
            moving = labelme._utils.project_point_on_line(
