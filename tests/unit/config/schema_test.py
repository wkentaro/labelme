...
from labelme.config.schema import KINDS
from labelme.config.schema import SECTIONS
from labelme.config.schema import SETTINGS
from labelme.config.schema import Setting
...
@pytest.mark.parametrize("setting", SETTINGS, ids=_ids())
def test_section_is_known(setting: Setting) -> None:
    assert setting.section in SECTIONS


@pytest.mark.parametrize("setting", SETTINGS, ids=_ids())
def test_kind_is_known(setting: Setting) -> None:
    assert setting.kind in KINDS
