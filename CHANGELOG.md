...
- Fixed failed Image navigation clearing the active Image, Annotation, canvas, and File List selection before the replacement had loaded. Missing or unreadable Images and invalid adjacent Annotation Files now leave the last good session active, and an invalid adjacent Annotation File still blocks its Image from opening ([#2468](https://github.com/wkentaro/labelme/pull/2468))
