...
- Fixed an AI Assist Sweep whose proposals all matched existing Shapes showing the same status message as an empty model result. The Sweep now reports that all proposals matched existing Shapes, while an empty model result keeps its existing message ([#2463](https://github.com/wkentaro/labelme/pull/2463))
