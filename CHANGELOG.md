...
- Fixed AI Assist and AI Text Prompt passing images to vision models in BGR channel order, which swapped red and blue. Qt images are now converted to RGB before inference. Oriented-rectangle Shapes produced by AI Assist near an Image edge are now kept within its bounds ([#2466](https://github.com/wkentaro/labelme/pull/2466))
