...
- Fixed AI Assist and AI Text Prompt oriented-rectangle Shapes near an Image edge extending beyond its bounds when out-of-bounds points are disabled. Rectangles that fit are translated without deformation; only an axis larger than the Image is clipped, while enabling out-of-bounds points preserves the original vertices ([#2506](https://github.com/wkentaro/labelme/pull/2506))
